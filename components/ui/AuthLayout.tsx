...
const heightImage= theme === 'dark' ? 150 : 411; 
  ...
  return (
    <main className={`${nunito_sans.className} flex min-h-screen dark:bg-gray-900`}>
     
    
     

      {/*konten form*/}
      <div className="flex w-full flex-col items-center justify-center bg-white md:w-1/2 dark:bg-black dark:text-white">
