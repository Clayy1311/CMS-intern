import { postContentEntry, updateContentEntry, deleteContentEntry, indexContentEntry } from "../../../controllers/contentMangement/personalProjects/contentEntry.controller";
...
router.get("/personal-projects/:personalProjectId/content-entry/:contentEntryId", personalProjectAccess, indexContentEntry)
